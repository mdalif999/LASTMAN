...
def pos_page(page, navigate=None):
    ...
    brand_filter_dropdown = ft.Dropdown(
        ...
        text_size=12, content_padding=10, value="All",
    ...
    discount_amount_text = ft.Text("0.00 TK", size=18, weight=ft.FontWeight.BOLD, color="red")
    ...
    def update_bill_btn():
        ...
        if not has_items:
            # ✅ কোনো item select না থাকলে লাল + disabled
    ...
    def calculate_totals():
        ...
        discount_amount_text.value = f"{d_amt:,.2f} TK"
    ...
    discount_input = ft.TextField(
        label="Disc %", hint_text="0", width=100, height=45,
        text_size=18, text_vertical_align=1,
        input_filter=num_filter,
        text_align=ft.TextAlign.CENTER,
        text_style=ft.TextStyle(weight=ft.FontWeight.W_900, color=ft.Colors.BLACK),
...
# ============================================================
    ...
    def on_input_change(item, inputs, amount_text):
        try:
            ...
            price_per_full_unit = float(item[9] or 0)
    ...
    def load_table(query=""):
        ...
        for idx, item in enumerate(inventory_raw_data):
                ...
                content=ft.Column([
                    ...
                    ft.Row([
                        ft.Column([
                            ...
                            ft.Text(f"Discount: {d_amt:,.2f} TK",         size=16, weight=ft.FontWeight.BOLD, color="red")
                        ]),
                        ft.Column([
                            ft.Row([ft.Text("SUB TOTAL:",   size=16, weight=ft.FontWeight.BOLD, color="black"),
                                    ft.Text(f"{sub_total:,.2f} TK", size=16, weight=ft.FontWeight.BOLD, color="black")],
                                   alignment="spaceBetween", width=420),
                            ft.Row([ft.Text("GRAND TOTAL:", size=19, weight=ft.FontWeight.BOLD, color="black"),
    ...
    return ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Row([
                ...
                ft.Container(
                    content=brand_filter_dropdown, width=150, height=48
                ),
                ft.Container(
                    content=color_filter_dropdown, width=150, height=48
                ),
                search_field,
                ft.ElevatedButton(
                    "View Cart",
            ...
            # Table
            ft.Container(
                content=ft.ListView([main_table], expand=True),
                expand=True,
                ...
                content=ft.Column([
                    ft.Row([
                        ...
                        ft.Column([
                            ...
                            ft.Row([
                                ft.Text("DISCOUNT (-):", weight=ft.FontWeight.W_900, size=15, color="red"),
